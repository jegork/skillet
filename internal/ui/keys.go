...
type keyMap struct {
	...
	Confirm, TogglePush, Install                                                  key.Binding
...
func (k keyMap) ShortHelp() []key.Binding {
	return []key.Binding{k.Edit, k.Toggle, k.Sync, k.Install, k.Filter, k.Doctor, k.Help, k.Quit}
}

func (k keyMap) FullHelp() [][]key.Binding {
	return [][]key.Binding{
		{k.Up, k.Down, k.Filter, k.Focus},
		{k.Edit, k.Toggle, k.Rename, k.Sync, k.Install, k.Doctor, k.Reload, k.Readme},
